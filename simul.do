...
// Outputs
	...
	* Return Brier score
	summ brier_s
		...
		*scalar brier_sum_s = r(sum)
	summ brier_s_flip
		return scalar brier_s_flip = r(mean)
		*scalar brier_sum_s_flip = r(sum)
	summ brier_s_random
		return scalar brier_s_random = r(mean)
		*scalar brier_sum_s_random = r(sum)
	summ brier_u
		return scalar brier_u = r(mean)
		*scalar brier_sum_u = r(sum)
	summ brier_u_flip
		return scalar brier_u_flip = r(mean)
		*scalar brier_sum_u_flip = r(sum)
	summ brier_u_random
		return scalar brier_u_random = r(mean)
		*scalar brier_sum_u_random = r(sum)
	** Correct predictions
	* Shrunk
...
b = r(b) b_flip = r(b_flip) p = r(p) p_flip = r(p_flip) t_s=r(va_s_diff) t_u=r(va_u_diff) ///
...
// Graphs
	...
	** Kdensity Brier score
	qui twoway kdensity brier_s  ///
	|| kdensity brier_s_random || kdensity brier_s_flip, xtitle("Brier Score") ///
	legend(label(1 "Brier score") label(2 "Brier score flip") ///
	 label(3 "Brier score random")) ///
	ytitle(Frequency)
	graph export "`path'/Output/PAP/brier_s_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png.png", as(png) replace
	...
	** Kdensity Brier score differences
	...
	|| kdensity brier_diff_s_flip || kdensity brier_diff_u_random ///
	|| kdensity brier_diff_u_flip, ///
	xtitle("Brier Score Differences") legend(label(1 "Shrunk. Standard vs Random") ///
	label(2 "Shrunk. Standard vs Flipped") ///
	label(3 "Unshrunk. Standard vs Random") ///
	label(4 "Unshrunk. Standard vs Flipped")) ytitle(Frequency)
	graph export "`path'/Output/PAP/brierdiff_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace*/
	...
	title("Brier diff. Shrunk") ///
	xtitle("Brier Score Differences") ///
	ytitle(Frequency)
	graph export "`path'/Output/brierdiff_s_flip_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	xtitle("Brier Score Differences") ///
	ytitle(Frequency)
	graph export "`path'/Output/brierdiff_s_random_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	xtitle("Brier Score Differences") ///
	ytitle(Frequency)
	graph export "`path'/Output/brierdiff_u_flip_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	xtitle("Brier Score Differences") ///
	ytitle(Frequency)
	graph export "`path'/Output/brierdiff_u_random_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace	
	...
	** Kdensity Brier score U predictions but S outcomes
	...
	graph export "`path'/Output/brierus_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	** Kdensity Brier score difference U predictions but S outcomes
	...
	graph export "`path'/Output/brierusdiff_r_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	
	qui twoway kdensity brier_diff_us_flip_sout   ///
	|| kdensity brier_diff_us_flip_fout, ///
	xtitle("Brier Score diff. U predictions. S outcomes") legend(label(1 "Standard outcomes") ///
	label(2 "Flipped outcomes")) ytitle(Frequency) 
	graph export "`path'/Output/brierusdiff_f_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
...
** Kdensity pct corr predictions differences
	...
	ytitle(Frequency)
	graph export "`path'/Output/corrpreddiff_s_flip_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	xtitle("Correct Predictions Differences") ///
	ytitle(Frequency)
	graph export "`path'/Output/corrpreddiff_s_random_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	xtitle("Correct Predictions Differences") ///
	ytitle(Frequency)
	graph export "`path'/Output/corrpreddiff_u_flip_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	xtitle("Correct Predictions Differences") ///
	ytitle(Frequency)
	graph export "`path'/Output/corrpreddiff_u_random_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace	
...
** Kdensity logloss differences
	...
	ytitle(Frequency)
	graph export "`path'/Output/loglossdiff_s_flip_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	xtitle("Log loss Differences") ///
	ytitle(Frequency)
	graph export "`path'/Output/loglossdiff_s_random_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	xtitle("Log loss Differences") ///
	ytitle(Frequency)
	graph export "`path'/Output/loglossdiff_u_flip_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	xtitle("Log loss Differences") ///
	ytitle(Frequency)
	graph export "`path'/Output/loglossdiff_u_random_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace		
	...
	** Kdensity Correct predictions
	...
	graph export "`path'/Output/corrpred_s_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	qui twoway kdensity pred_correct_u   || kdensity pred_correct_u_random || kdensity pred_correct_u_flip, ///
	xtitle("Percent correct predictions") legend(label(1 "Predictions") ///
	label(2 "Predictions random outcomes") ///
	label(3 "Predictions flipped outcomes")) ytitle(Frequency)
	graph export "`path'/Output/corrpred_u_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	...
	** Kdensity log loss
	...
	graph export "`path'/Output/logloss_s_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
	qui twoway kdensity logloss_u   || kdensity logloss_u_random || kdensity logloss_u_flip, ///
	xtitle("Log loss") legend(label(1 "Baseline") ///
	label(2 "Random outcomes") ///
	label(3 "Flipped outcomes")) ytitle(Frequency)
	graph export "`path'/Output/logloss_u_p`p'_c`cases_exp'_m`min_cases'_nsim`n_sim'_pull`datapull'.png", as(png) replace
...
** p-value diff brier	
twoway kdensity brier_diff_s_random || kdensity brier_diff_s_random_rout
